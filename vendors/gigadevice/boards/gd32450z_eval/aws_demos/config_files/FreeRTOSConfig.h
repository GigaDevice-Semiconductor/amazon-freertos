...
#define configMAX_PRIORITIES                          ( 8 )//8
...
#define configTIMER_TASK_PRIORITY                     ( configMAX_PRIORITIES - 2 )//2
...
void vLoggingPrintf( const char * pcFormat,
                     ... );
extern void vMyUSARTOutput( char *str );
...
#define configPRINT_STRING( x )         vMyUSARTOutput( x )// or printf
...
#define configPLATFORM_NAME    "GD32F450Z-EVAL"
...
#define configDNS_SERVER_ADDR0    114
#define configDNS_SERVER_ADDR1    114
#define configDNS_SERVER_ADDR2    114
#define configDNS_SERVER_ADDR3    114
